...
return {
	tracks = {
		{ name = "ice3/stehen1.wav", refDist = 25.0 },
		{ name = "ice3/drive3.wav", refDist = 25.0 },
		{ name = "ice3/summen.wav", refDist = 25.0 },
		{ name = "ice3/drive3.wav", refDist = 25.0 },
		{ name = "ice3/roll.wav", refDist = 25.0 },
		{ name = "ice3/kurve.wav", refDist = 20.0 },
		{ name = "ice3/bremsen.wav", refDist = 25.0 },

	},
	events =  {
		horn = { names = { "ice3/horn.wav" }, refDist = 25.0 },
